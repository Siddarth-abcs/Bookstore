...
export const Navbar = ({cartItems}) => {
  ...
  const [cartnumber,setCartnumber] = useState(cartItems)
        ...
        <div className='px-8 py-6 flex justify-between'>
          ...
          <Link to={'/cart'}>
            ...
            <div className="t-0 absolute left-3">
              <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{cartnumber}</p>
            </div>
