  ...
  return (
    <div className="w-11/12 my-12 mx-auto">
      ...
      <div className="px-5 my-12 border-solid border-2 border-sky-200 rounded-lg shadow-lg">
        ...
        <div className="my-8">
          <h2 className="text-xl my-4 font-bold">Shiping details</h2>
          <form>
            <div className="mb-5">
              <input
                type="text"
        ...
        <div>
          ...
          <div className="container mx-auto p-4">
            ...
            {checkoutData.map((item, index) => (
              ...
              >
                <div className="flex items-center relative">
                  ...
                  />
                  <span
                    className="absolute -top-3 left-0 text-red-500 text-2xl font-bold"
            ...
            <button class="bg-purple-500 hover:bg-purple-700 text-white text-xl font-bold py-3 my-8 w-full rounded flex justify-center items-center">
              <svg
      ...
      <div class="container mx-auto p-4">
        ...
        <div class="text-global-accent text-center p-4 rounded-md shadow-md mb-4">
          <h2 class="text-xl font-semibold mb-2">IS THIS WEBSITE LEGIT?</h2>
